...
Usado para registrar las acciones de cada Agente en la simulacion OASIS, para monitoreo del backend
...
class PlatformActionLogger:
    """Registrador de acciones de una sola plataforma"""
    ...
    def __init__(self, platform: str, base_dir: str):
        ...
        Args:
            ...
            base_dir: Ruta base del directorio de simulacion
        """
    ...
    def log_simulation_start(self, config: Dict[str, Any]):
        """Registrar inicio de simulacion"""
        entry = {
            "timestamp": datetime.now().isoformat(),
...
class SimulationLogManager:
    """
    Gestor de logs de simulacion
    Gestiona unificadamente todos los archivos de log, separados por plataforma
    """
    ...
    def __init__(self, simulation_dir: str):
        ...
        Args:
            simulation_dir: Ruta del directorio de simulacion
        """
    ...
    def _setup_main_logger(self):
        """Configurar log principal de simulacion"""
    ...
    def get_twitter_logger(self) -> PlatformActionLogger:
        """Obtener registrador de plataforma Twitter"""
    ...
    def get_reddit_logger(self) -> PlatformActionLogger:
        """Obtener registrador de plataforma Reddit"""
...
class ActionLogger:
    """
    Registrador de acciones (interfaz antigua)
