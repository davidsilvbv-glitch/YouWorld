"""
Test de formato de generacion de Profile
# Validar que el formato de generación de Profile cumpla con los requisitos de OASIS
Validar:
1. Twitter Profile genera formato CSV
2. Reddit Profile genera formato JSON detallado
"""
...
def test_profile_formats():
    """Test de formato de Profile"""
    print("=" * 60)
    print("Test de formato OASIS Profile")
    print("=" * 60)
    
    # Crear datos de Profile de test
    test_profiles = [
        OasisAgentProfile(
            user_id=0,
...
def show_expected_formats():
    """Mostrar formato esperado por OASIS"""
    print("\n" + "=" * 60)
