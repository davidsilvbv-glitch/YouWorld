...
.report-panel {
  --report-bg: #f4efe6;
  --report-paper: rgba(255, 251, 245, 0.92);
  --report-paper-strong: #fffdf8;
  --report-ink: #1f2430;
  --report-muted: #6f7684;
  --report-accent: #c85b31;
  --report-accent-soft: rgba(200, 91, 49, 0.14);
  --ops-bg: #101723;
  --ops-surface: rgba(19, 28, 43, 0.86);
  --ops-surface-strong: rgba(26, 37, 56, 0.94);
  --ops-border: rgba(255, 255, 255, 0.09);
  --ops-border-strong: rgba(255, 214, 170, 0.24);
  --ops-text: #edf2ff;
  --ops-muted: #95a2bc;
  --ops-accent: #ff8c5a;
  --ops-accent-2: #f3c86a;
  ...
  background:
    radial-gradient(circle at top left, rgba(255, 176, 115, 0.16), transparent 28%),
    radial-gradient(circle at 82% 18%, rgba(255, 112, 67, 0.12), transparent 20%),
    linear-gradient(135deg, #ede5d8 0%, #f6f0e8 42%, #efe7dd 100%);
...
.panel-header {
  ...
  gap: 10px;
  padding: 16px 22px;
  background: linear-gradient(180deg, rgba(24, 34, 51, 0.98), rgba(18, 26, 40, 0.98));
...
.header-dot {
  ...
  box-shadow: 0 0 0 4px rgba(255, 140, 90, 0.14);
  margin-right: 10px;
  flex-shrink: 0;
...
.panel-header--de {
  background: linear-gradient(180deg, rgba(32, 43, 63, 0.98), rgba(17, 25, 39, 0.98));
...
.panel-header--hecho {
  background: linear-gradient(180deg, rgba(19, 49, 39, 0.98), rgba(15, 39, 32, 0.98));
}
...
.left-panel.report-style {
  ...
  min-width: 450px;
  background:
    linear-gradient(180deg, rgba(255, 250, 243, 0.95), rgba(253, 246, 236, 0.9)),
    repeating-linear-gradient(
      180deg,
      rgba(200, 91, 49, 0.03) 0,
      rgba(200, 91, 49, 0.03) 1px,
      transparent 1px,
      transparent 34px
    );
  border-right: 1px solid rgba(110, 78, 44, 0.12);
  overflow-y: auto;
  display: flex;
  flex-direction: column;
  padding: 38px 52px 68px 52px;
...
.report-content-wrapper {
  ...
  border: 1px solid rgba(110, 78, 44, 0.1);
  border-radius: 28px;
  background:
    linear-gradient(180deg, rgba(255, 252, 248, 0.98), rgba(255, 249, 242, 0.96));
  box-shadow:
    0 22px 50px rgba(111, 86, 50, 0.08),
...
.report-tag {
  background: linear-gradient(135deg, #20180f, #513322);
  color: #fff5eb;
  font-size: 11px;
  font-weight: 700;
  padding: 6px 10px;
  ...
  text-transform: uppercase;
  border-radius: 999px;
  box-shadow: 0 10px 20px rgba(81, 51, 34, 0.18);
}
...
.header-divider {
  height: 2px;
  background: linear-gradient(90deg, rgba(200, 91, 49, 0.7), rgba(200, 91, 49, 0.08));
  width: 100%;
  border-radius: 999px;
}
...
.report-section-item {
  ...
  border: 1px solid rgba(110, 78, 44, 0.08);
  box-shadow: 0 12px 24px rgba(111, 86, 50, 0.05);
}
...
.section-header-row.clickable:hover {
  background-color: rgba(200, 91, 49, 0.06);
}
...
.report-section-item.is-de {
  background: linear-gradient(180deg, rgba(255, 244, 235, 0.96), rgba(255, 249, 242, 0.92));
  border-color: rgba(200, 91, 49, 0.24);
  box-shadow: 0 18px 30px rgba(200, 91, 49, 0.12);
}
...
.generated-content :deep(.md-h2) { font-size: 20px; border-bottom: 1px solid rgba(200, 91, 49, 0.14); padding-bottom: 8px; }
...
.right-panel {
  flex: 1;
  background:
    radial-gradient(circle at top right, rgba(255, 140, 90, 0.12), transparent 22%),
    linear-gradient(180deg, #0e1622 0%, #101a28 52%, #0d141f 100%);
  overflow-y: auto;
  display: flex;
  flex-direction: column;

  /* Functional palette (low saturation, status-based) */
  --wf-border: var(--ops-border);
  --wf-divider: rgba(255, 255, 255, 0.07);

  --wf-de-bg: rgba(38, 51, 75, 0.86);
  --wf-de-border: rgba(255, 140, 90, 0.36);
  --wf-de-dot: var(--ops-accent);
  --wf-de-text: #fff0e7;

  --wf-hecho-bg: rgba(20, 52, 45, 0.88);
  --wf-hecho-border: rgba(61, 205, 152, 0.22);
  --wf-hecho-dot: #3dcd98;

  --wf-muted-dot: rgba(186, 196, 216, 0.38);
  --wf-todo-text: #8592ad;
}
...
.next-step-btn {
  ...
  font-weight: 600;
  color: #fff8f3;
  background: linear-gradient(135deg, #e36b39 0%, #f19b62 52%, #f0b45f 100%);
  border: none;
  border-radius: 16px;
  cursor: pointer;
  transition: all 0.2s ease;
  box-shadow: 0 18px 30px rgba(227, 107, 57, 0.28);
}

.next-step-btn:hover {
  transform: translateY(-1px);
  box-shadow: 0 22px 38px rgba(227, 107, 57, 0.36);
}
...
.console-logs {
  background:
    linear-gradient(180deg, rgba(7, 10, 16, 0.96), rgba(5, 8, 13, 0.98));
  color: #d8dfeb;
...
/* Dynamic result widgets still ship a light theme; force them into the phase palette */
.report-panel :deep(.stat-box),
.report-panel :deep(.stat-box.highlight),
.report-panel :deep(.stat-box.muted),
.report-panel :deep(.query-display),
.report-panel :deep(.expand-details),
.report-panel :deep(.detail-content),
.report-panel :deep(.fact-row.de),
.report-panel :deep(.fact-idx),
.report-panel :deep(.entity-chip),
.report-panel :deep(.chip-type),
.report-panel :deep(.rel-node),
.report-panel :deep(.rel-edge),
.report-panel :deep(.agent-tab),
.report-panel :deep(.agent-tab.de),
.report-panel :deep(.tab-avatar),
.report-panel :deep(.profile-avatar),
.report-panel :deep(.selection-reason),
.report-panel :deep(.q-badge),
.report-panel :deep(.a-badge),
.report-panel :deep(.platform-btn.de),
.report-panel :deep(.quote-item),
.report-panel :deep(.insight-header),
.report-panel :deep(.insight-tabs),
.report-panel :deep(.insight-tab),
.report-panel :deep(.insight-tab.de),
.report-panel :deep(.insight-content),
.report-panel :deep(.insight-display .fact-item),
.report-panel :deep(.insight-display .fact-number),
.report-panel :deep(.insight-display .entity-tag),
.report-panel :deep(.insight-display .entity-type),
.report-panel :deep(.insight-display .entity-card),
.report-panel :deep(.insight-display .entity-fact-count),
.report-panel :deep(.insight-display .relation-item),
.report-panel :deep(.insight-display .rel-source),
.report-panel :deep(.insight-display .rel-target),
.report-panel :deep(.insight-display .rel-label),
.report-panel :deep(.insight-display .subquery-item),
.report-panel :deep(.insight-display .subquery-number),
.report-panel :deep(.panorama-header),
.report-panel :deep(.panorama-tabs),
.report-panel :deep(.panorama-tab),
.report-panel :deep(.panorama-tab.de),
.report-panel :deep(.panorama-content),
.report-panel :deep(.panorama-display .fact-item),
.report-panel :deep(.panorama-display .fact-number),
.report-panel :deep(.panorama-display .fact-item.historical .fact-number),
.report-panel :deep(.panorama-display .entity-tag),
.report-panel :deep(.panorama-display .entity-type),
.report-panel :deep(.quicksearch-header),
.report-panel :deep(.quicksearch-tabs),
.report-panel :deep(.quicksearch-tab),
.report-panel :deep(.quicksearch-tab.de),
.report-panel :deep(.quicksearch-content),
.report-panel :deep(.quick-search-display .fact-item),
.report-panel :deep(.quick-search-display .fact-number),
...
.report-panel :deep(.section-label),
.report-panel :deep(.fact-text),
.report-panel :deep(.chip-type),
.report-panel :deep(.interview-display .header-title),
.report-panel :deep(.interview-display .header-topic),
.report-panel :deep(.interview-display .stat-label),
.report-panel :deep(.interview-display .stat-size),
.report-panel :deep(.interview-display .profile-rLete),
...
.report-panel :deep(.interview-display .answer-text),
.report-panel :deep(.interview-display .quotes-header),
.report-panel :deep(.interview-display .quote-item),
.report-panel :deep(.interview-display .summary-header),
.report-panel :deep(.interview-display .summary-content),
.report-panel :deep(.interview-display .summary-content h2),
.report-panel :deep(.interview-display .summary-content h3),
.report-panel :deep(.interview-display .summary-content h4),
.report-panel :deep(.interview-display .summary-content strong),
.report-panel :deep(.interview-display .summary-content blockquote),
.report-panel :deep(.insight-header .header-title),
.report-panel :deep(.insight-header .header-topic),
.report-panel :deep(.insight-header .stat-value),
.report-panel :deep(.insight-header .stat-label),
.report-panel :deep(.insight-header .stat-size),
...
.report-panel :deep(.insight-display .entity-name),
.report-panel :deep(.insight-display .entity-summary),
.report-panel :deep(.insight-display .subquery-text),
.report-panel :deep(.panorama-header .header-title),
.report-panel :deep(.panorama-header .header-topic),
.report-panel :deep(.panorama-header .stat-value),
.report-panel :deep(.panorama-header .stat-label),
.report-panel :deep(.panorama-header .stat-size),
.report-panel :deep(.panorama-display .panel-title),
.report-panel :deep(.panorama-display .panel-count),
.report-panel :deep(.panorama-display .fact-content),
.report-panel :deep(.panorama-display .fact-time),
.report-panel :deep(.panorama-display .entity-name),
.report-panel :deep(.quicksearch-header .header-title),
.report-panel :deep(.quicksearch-header .header-query),
.report-panel :deep(.quicksearch-header .stat-value),
.report-panel :deep(.quicksearch-header .stat-label),
.report-panel :deep(.quicksearch-header .stat-size),
...
.report-panel :deep(.interview-display .answer-text strong),
...
.report-panel :deep(.interview-display .agent-tabs),
.report-panel :deep(.interview-display .quotes-section),
.report-panel :deep(.interview-display .summary-section),
.report-panel :deep(.interview-display .selection-reason),
.report-panel :deep(.interview-display .expand-answer-btn),
...
.report-panel :deep(.detail-content),
.report-panel :deep(.fact-row),
.report-panel :deep(.relation-row),
.report-panel :deep(.interview-display .summary-content blockquote) {
  border-color: rgba(235, 255, 251, 0.08) !important;
}
